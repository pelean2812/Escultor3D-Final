...
//Usamos um metodo para criar um arquivo .off e enviar uma caixa de confirmação na tela do user
void Plotter::criaOff(){
    s->writeOFF((char*)"Escultura3D.off");
    QMessageBox box;
    QString msg;
    msg = "Arquivo .OFF gravado com sucesso.";
    box.setText(msg);
    box.exec();
}
